    ...
    <div class='segment-a'>
        <div class='segment-inner'>
            ...
            <div class='col-4'>
                ...
                <p><a href="https://www.patreon.com/3dmodelhaven/overview" target="_blank">Join <?php echo sizeof($GLOBALS['PATRON_LIST']) ?> generous patrons</a> to help us keep making <?php echo $GLOBALS['CONTENT_TYPE_NAME'] ?>.</p>
            </div>
        </div>
    </div>
