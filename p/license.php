...
<div id="page-wrapper">
    <h1>3D Model License</h1>
    <p>All models on this site are licensed as <a href="https://creativecommons.org/publicdomain/zero/1.0/">CC0</a> - which is the most liberal license I know of.</p>
    ...
    <p>In other words:</p>
    <ul>
        <li><b>You can use the models for any purpose</b>, including commercial work.</li>
    ...
    <p>The only thing you can't do is claim to be the original author of the models.</p>
    ...
    <p><b>Disclaimer:</b> occasionally a brand name, logo or other copyrighted design may appear in the models. It is the responsibility of the user not to infringe on these copyrights in their own work.</p>
