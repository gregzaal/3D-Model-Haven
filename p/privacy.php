...
<div id="page-wrapper">
    ...
    <p>
        If you are not comfortable with this, you can use an ad-blocker such as <a href="https://github.com/gorhill/uBlock">uBlock Origin</a> to block all tracking by Google Analytics. Note that 3D Model Haven does not display ads, so I'm fully comfortable with and encourage you to use an ad-blocker.
    </p>
