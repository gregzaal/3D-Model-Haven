...
if ($is_published){
    ...
    if($author_info){
        ...
        if ($author_info['donate']){
            if (starts_with($author_info['donate'], "paypal:")){
                ...
                $author_info['donate'] = paypal_email_to_link($author_info['donate'], "3D Model Haven: ".$info['name']);
            }
    ...
    echo "</ul>";
    echo "<p class='small'><a href='https://polyhaven.com/support-us'>Support 3D Model Haven</a><br>to add your name here.</p>";
    echo "</div>";
