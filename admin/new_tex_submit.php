...
if ($result == 1){
    ...
    $vars = [
        "name" => $name,
        "link" => "https://3dmodelhaven.com/tex/?t=".$slug,
    ];
    ...
    $sql_fields['link'] = "https://3dmodelhaven.com/tex/?t=".$slug;
    $sql_fields['image'] = "https://3dmodelhaven.com/files/tex_images/spheres/".$slug.".jpg";
